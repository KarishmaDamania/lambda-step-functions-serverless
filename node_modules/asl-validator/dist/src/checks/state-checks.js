...
var stateChecks = function (definition, options, checks) {
    ...
    (0, get_states_1.getStatesContainer)(definition).forEach(function (states) {
        ...
        (0, get_states_1.getStates)(states).forEach(function (entry) {
            ...
            errorMessages.push.apply(errorMessages, checks.filter(function (check) {
...
var getPropertyCount = function (_a) {
    ...
    return props.map(function (prop) { return prop in object ? 1 : 0; })
...
var AtMostOne = function (_a) {
    ...
    return function (_a) {
        ...
        var object = path ? (0, jsonpath_plus_1.JSONPath)({
            path: path,
            json: state,
            wrap: false,
        }) : state;
        ...
        if (count > 1) {
            return {
                ...
                Message: "State \"".concat(stateName, "\" MUST contain at most one of ").concat(props.map(function (p) {
                    return "\"".concat(p, "\"");
                }).join(", ")),
            };
        }
    ...
    return function (_a) {
        ...
        if (count !== 1) {
            return {
                ...
                // Use of JSONPath within the error message is unnecessary
                // since the state names are unique.
                Message: "State \"".concat(stateName, "\" MUST contain exactly one of ").concat(props.map(function (p) {
                    return "\"".concat(p, "\"");
                }).join(", ")),
            };
        }
